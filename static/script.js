...
// 获取默认颜色块元素
 ...
 // 获取颜色选择单选按钮
    ...
    changeBackground('linear-gradient(60deg, #29323c 0%, #485563 100%)')
    ...
    // 设置复选框的默认状态为选中
    showAvatarCheckbox.checked = false;
    ...
    showQrCodeCheckbox.checked = false;
    showNotecardCheckbox.checked = false;
    ...
    themeStylesheet.href = themeUrls['artisan'];
